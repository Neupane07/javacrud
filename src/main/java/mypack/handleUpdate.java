...
@WebServlet(urlPatterns = {"/handleUpdate"})
public class handleUpdate extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        if (session.getAttribute("uname") == null) {
            ...
            Connection con = null;
            out.println("<form action='handleUpdate2' method='post'>");
            ...
            try {
                ...
                str += "</select><br>";
                out.println(str);
                out.println("<input class='ui button'type='submit' value='Update selected record'>");
